...
class Portgroup(base.APIBase):
    ...
    def _set_node_uuid(self, value):
        if value and self._node_uuid != value:
            # NOTE(vdrok): When we create a portgroup this method
            # is called before post() as result user may recieve
