...
# v1.17: Add portgroup support
# v1.18: Add network interface attribute to node
...
MINOR_17_PORTGROUP = 17
MINOR_18_NETWORK_INTERFACE = 18

# When adding another version, update MINOR_MAX_VERSION and also update
# doc/source/webapi/v1.rst with a detailed explanation of what the version has
# changed.
MINOR_MAX_VERSION = MINOR_18_NETWORK_INTERFACE
