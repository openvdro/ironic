...
# v1.16: Add portgroup support
# v1.17: Add network provider attribute to node
...
MINOR_16_PORTGROUP = 16
MINOR_17_NETWORK_PROVIDER = 17

# When adding another version, update MINOR_MAX_VERSION and also update
# doc/source/webapi/v1.rst with a detailed explanation of what the version has
# changed.
MINOR_MAX_VERSION = MINOR_17_NETWORK_PROVIDER
