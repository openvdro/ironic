...
**1.18**
    ...
    This API version adds the network_interface attribute to a node.

**1.17**

    This API version adds the portgroup support:

    * '/v1/nodes/<node>/portgroups'
    * '/v1/portgroups/'

    Add node ``portgroup`` fields.
...
.. rest-controller:: ironic.api.controllers.v1.portgroup:PortgroupsController
   :webprefix: /v1/portgroups

.. autotype:: ironic.api.controllers.v1.portgroup.PortgroupCollection
   :members:

.. autotype:: ironic.api.controllers.v1.portgroup.Portgroup
   :members:
